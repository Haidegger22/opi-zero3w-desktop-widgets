...
- **Снизу экрана** — узкая полоска-ручка с зелёным неоновым ореолом
...
- Панель с **тёмным жидким стеклом**: тёмная полупрозрачная основа + размытый снимок фона
  + мягкий вертикальный градиент (свет у верхней кромки → тень у нижней)
